...
class GoalCreateRequestRevenue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'goal' => '\OpenAPI\Client\Model\GoalCreateRequestRevenueGoal',
        'goal_type' => 'string'
    ];
    ...
    */
     ...
     * Gets goal
     *
     * @return \OpenAPI\Client\Model\GoalCreateRequestRevenueGoal
     */
     ...
     * Sets goal
     *
     * @param \OpenAPI\Client\Model\GoalCreateRequestRevenueGoal $goal goal
     *
     * @return self
     */
