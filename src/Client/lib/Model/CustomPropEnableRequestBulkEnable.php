    ...
    */
    ...
    public function setCustomProps($custom_props)
    {
        ...
        if ((count($custom_props) < 1)) {
            throw new \InvalidArgumentException('invalid length for $custom_props when calling CustomPropEnableRequestBulkEnable., number of items must be greater than or equal to 1.');
        }
