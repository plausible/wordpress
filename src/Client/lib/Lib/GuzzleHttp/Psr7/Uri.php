...
use Plausible\Analytics\WP\Client\Lib\GuzzleHttp\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable
{
     ...
     * `Plausible\Analytics\WP\Client\Lib\Psr\Http\Message\UriInterface::__toString`.
     *
     ...
     *
     * `Plausible\Analytics\WP\Client\Lib\Psr\Http\Message\UriInterface::getPort` may return null or the standard port. This method can be used
